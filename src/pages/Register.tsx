          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <span className="text-[11px] font-black uppercase tracking-[0.15em]">Sign up with Google</span>
                <div className="absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-[#c084fc]/30 to-transparent scale-x-0 group-hover:scale-x-100 transition-transform duration-500" />
              </Button>
              ...
              <div className="relative py-2">
                ...
                <div className="relative flex justify-center">
                  <span className="px-2 bg-transparent text-[9px] font-black uppercase tracking-widest text-white/20">or industrial sign up</span>
                </div>
              </div>
            </div>
